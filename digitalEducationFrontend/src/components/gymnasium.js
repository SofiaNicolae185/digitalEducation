        ...
        <Grid container direction={"column"}>
          ...
          <TabPanel value={value} index={0}>
            ...
            <TabPanel value={valueCPP} index={0}>
              <Grid style={desc}>
                ...
                by Danish computer scientist Bjarne Stroustrup as an extension
                of the C programming language, or "C with Classes". The language
                has expanded significantly over time, and modern C++ now has
                object-oriented, generic, and functional features in addition to
                facilities for low-level memory manipulation. It is almost
                always implemented as a compiled language, and many vendors
                provide C++ compilers, including the Free Software Foundation,
                LLVM, Microsoft, Intel, Embarcadero, Oracle, and IBM, so it is
                available on many platforms. std::cout {'<< "Hello World!"'};
              </Grid>
            </TabPanel>
            <TabPanel value={valueCPP} index={1}>
              <Grid style={desc}>
                The basic data types are integer-based and floating-point based.
                C++ language supports both signed and unsigned literals. The
                memory size of basic data types may change according to 32 or 64
            ...
            <TabPanel value={valueCPP} index={2}>
              <Grid style={desc}>
                ...
                values. For example, + is an operator used for addition, while -
                ...
                <br />
                The operators +, - and * compute addition, subtraction, and
            ...
            <TabPanel value={valueCPP} index={3}>
              <Grid style={desc}>
                ...
                both belonging to the same class on a member-by-member copy
                basis.
                <br />
                ...
                <br />
                An implicitly defined copy constructor will copy the bases and
                members of an object in the same order that a constructor would
                initialize the bases and members of the object.
                <br />
                2. User Defined Copy Constructor
                <br />A user-defined copy constructor is generally needed when
                an object owns pointers or non-shareable references, such as to
                a file, in which case a destructor and an assignment operator
                ...
                <br />b{")"} When an object of the class is passed (to a
                function) by value as an argument.
                <br />c{")"} When an object is constructed based on another
                object of the same class.
                <br />d{")"} When the compiler generates a temporary object.
                <br />
                It is, however, not guaranteed that a copy constructor will be
                called in all these cases, because the C++ Standard allows the
                compiler to optimize the copy away in certain cases, one example
                is the return value optimization.
              </Grid>
            </TabPanel>
          </TabPanel>
          ...
          <TabPanel value={value} index={1}>
            ...
            >
              ...
              <Tab
                style={styleTab}
                label="How do we put an image on a webpage?"
              />
              <Tab
                style={styleTab}
                label="How to set the font color in HTML?"
              />
            ...
            <TabPanel value={valueHTML} index={0}>
              ...
              <Grid style={desc}>
                <ul>
                  ...
                  <li>
                    ...
                    HTML document. Text between html tag describes the web
                    document. It is a container for all other elements of HTML
                    except {"<!DOCTYPE> "}
                  </li>
                  <li>
                    {"<head>: "} It should be the first element inside the{" "}
                    {"<html> "} element, which contains the metadata(information
                    about the document). It must be closed before the body tag
                    opens.
                  </li>
                  <li>
                    {"<title>: "} As its name suggested, it is used to add title
                    of that HTML page which appears at the top of the browser
                    window. It must be placed inside the head tag and should
                    close immediately. (Optional)
                  </li>
                  <li>
                    {"<body>"} : Text between body tag describes the body
                    content of the page that is visible to the end user. This
              ...
              <Grid style={desc}>WHY SHOULD WE LEARN HTML?</Grid>
              <Grid style={desc}>
                <ul>
                  <li>
                    {" "}
              ...
              <Grid style={desc}>Advantages:</Grid>
              <Grid style={desc}>
                <ul>
              ...
              <Grid style={desc}>Disadvantages:</Grid>
              <Grid style={desc}>
                <ul>
                  <li>
            ...
            <TabPanel value={valueHTML} index={1}>
              <Grid style={desc}>
                ...
                linked to web pages. The {"<img>"} tag creates a holding space
                for the referenced image.
                <br />
                The {"<img>"} tag is empty, it contains attributes only, and
                does not have a closing tag. The {"<img>"} tag has two required
                attributes:
              </Grid>
              <Grid style={desc}>
                <ul>
                  ...
                  <li>
                    alt - Specifies an alternate text for the image {"<"}img
                    src="url" alt="alternatetext"{">"}
                    {"<"}/img{">"}{" "}
                  </li>
                </ul>
              </Grid>
              <Grid style={desc}>
                ...
                same spot in relation to the web page, otherwise your visitors
                will get a broken link icon. The broken link icon and the alt
            ...
            <TabPanel value={valueHTML} index={2}>
              <Grid style={desc}>
                In order to set the font color in HTML, use the style attribute.
                The style attribute specifies an inline style for an element.
                The attribute is used with the HTML {"<p>"} tag, with the CSS
                property color. HTML5 do not support the {"<font>"} tag, so the
                CSS style is used to add font color. The {"<font>"} tag
                deprecated in HTML5. Just keep in mind, the usage of style
                attribute overrides any style set globally. It will override any
                style set in the HTML {"<style>"} tag or external style sheet.
                To change the text font family in HTML, use the style attribute.
                The style attribute specifies an inline style for an element.
                The attribute is used with the HTML {"<p>"} tag, with the CSS
                property font-family. HTML5 do not support the {"<font>"} tag,
                so the CSS style is used to add font size. Just keep in mind,
                the usage of style attribute overrides any style set globally.
                It will override any style set in the HTML {"<style>"} tag or
            ...
            <TabPanel value={valueHTML} index={3}>
              <Grid style={desc}>
                In order to set text alignment in HTML, use the style attribute.
                The style attribute specifies an inline style for an element.
                The attribute is used with the HTML {"<"}p{">"} tag, with the
                CSS property text-align for the center, left and right
                alignment. HTML5 do not support the align attribute of the {"<"}
                p{">"} tag, so the CSS style is used to set text alignment. Just
                keep in mind, the usage of style attribute overrides any style
                set globally. It will override any style set in the HTML {"<"}
                style{">"} tag or external style sheet.
                <br />
                {"<"}html{">"}
                <br />
                {"<"}head{">"}
          ...
          <TabPanel value={value} index={2}>
            ...
            <TabPanel value={valueCSS} index={0}>
              <Grid style={desc}>
                ...
                covers some key terms about the language. Prerequisites: Basic
                computer literacy, basic software installed, basic knowledge of
                working with files, and HTML basics (study Introduction to
                HTML.) Objective: To learn what CSS is. In the Introduction to
                HTML module, we covered what HTML is and how it is used to mark
                up documents. These documents will be readable in a web browser.
                Headings will look larger than regular text, paragraphs break
                onto a new line and have space between them. Links are colored
                and underlined to distinguish them from the rest of the text.
                What you are seeing are the browser's default styles — very
                basic styles — that the browser applies to HTML to make sure
                that the page will be basically readable even if no explicit
                styling is specified by the author of the page.
              </Grid>
            </TabPanel>
            <TabPanel value={valueCSS} index={1}>
              <Grid style={desc}>
                ...
                <br />• Always remains the same whether we apply internal or
                external styling
                <br />• There are few basic selectors like tags, id{"’"}s, and
                classes
                <br />• All forms this key-value pair
                <br />• Keys: properties{"("}attributes{")"} like color,
                font-size, background, width, height,etc
            ...
            <TabPanel value={valueCSS} index={2}>
              ...
              <Grid style={desc}>Inline CSS</Grid>
              <Grid style={desc}>
                <ul>
              ...
              <Grid style={desc}>
                ...
                <br />
                {"<"}p style =” color: green”{">"} I did this , I did that {"<"}
                /p{">"}
              </Grid>
              <Grid style={desc}>Internal CSS</Grid>
              <Grid style={desc}>
                <ul>
                  <li>
                    With the help of style tag, we can apply styles within the
                    HTML file
                  </li>
              ...
              <Grid style={desc}>External CSS</Grid>
              <Grid style={desc}>
                <ul>
                  <li>
                    With the help of {"<"}link{">"} tag in the head tag, we can
                    apply styles
                  </li>
              ...
              <Grid style={desc}>
                ...
                {"<"}head{">"}
                <br />
                {"<"}link rel="stylesheet" type="text/css" href="name of the Css
                file"{">"}
                <br />
                {"<"}/head{">"}
                <br /> h1{"{"}
            ...
            <TabPanel value={valueCSS} index={3}>
              <Grid style={desc}>
                CSS Colors There are different colouring schemes in CSS Three
              ...
              <Grid style={desc}>
                <ul>
                  ...
                  <li>
                    {" "}
                    Hex code starts with # and comprises of 6 numbers which are
              ...
              <Grid style={desc}>
                <ul>
                  ...
                  <li>
                    {" "}
                    4 parameter basically corresponds to red, green, blue and
                    alpha
                  </li>
                  <li>
                    {" "}
                    Value of the first three parameters may vary from 0 to 255
                    and the last parameter ranges from 0 to 1 that is from 0.1,
                    0.2,…..0.9
                  </li>
              ...
              <Grid style={desc}>
                ...
                <br />
                {"<"}p style="color:rgb(255,0,0)"{">"}This paragraph will be red
                {"<"}/p{">"}
                <br />
                ...
                <br />
                {"<"}/html{">"}
                This is the output of the above program showing different shades
                of red.
              </Grid>
            </TabPanel>
          </TabPanel>
